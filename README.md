...
![](https://img.shields.io/github/stars/plugget/plugget?color=grey&label=%E2%AD%90&style=flat-square) [![PyPI Downloads](https://img.shields.io/pypi/v/plugget)](https://pypi.org/project/plugget/) [plugget](https://github.com/plugget/plugget) a  package manager to search & (1-click) install tools in Blender, Maya, Max, Unreal, ...  
...
![](https://img.shields.io/github/stars/pyblish/pyblish-base?color=grey&label=%E2%AD%90&style=flat-square) [![PyPI](https://img.shields.io/pypi/v/pyblish)](https://pypi.org/project/pyblish/) [pyblish-base](https://github.com/pyblish/pyblish-base) Pyblish is a validation pipeline (e.g. for 3d assets). (Contributed for 1 year)  
...
[![](https://img.shields.io/github/stars/hannesdelbeke/electron-unity-hub?color=grey&label=%E2%AD%90&style=flat-square) electron-unity-hub](https://github.com/hannesdelbeke/electron-unity-hub) A Unity Hub that integrates with Git.  
